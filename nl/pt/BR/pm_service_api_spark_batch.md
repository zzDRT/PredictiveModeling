...
cliente para escoragem) para o modelo e armazenamento para a saída do modelo
...
lote. Deve-se fornecer as três entradas a
seguir:

Nota: exemplo de formulário:
...
É possível verificar o status, o href terminal e os parâmetros
relacionados ao modelo de implementação.
...
O resultado de predição é salvo em um arquivo .csv no IBM Object
